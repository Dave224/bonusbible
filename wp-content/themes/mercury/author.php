		...
		<div class="space-archive-title-box-h1 relative">
			...
			<?php if (get_the_author_meta('description')) { ?>
                <div class="space-news-3-items box-100 relative">
                    <div class="space-news-3-item user-box user-box-photo box-20 text-center left relative">
                        <?php echo get_wp_user_avatar( get_the_author_meta('ID'), 'original' ); ?>
                    </div>
                    <div class="space-news-3-item user-box box-80 left relative">
                        <p>
                            <?php echo renderBreakTagInString(get_the_author_meta( 'description' )); ?>
                        </p>
                    </div>
                </div>
			<?php } ?>

            <?php if (get_the_author_meta('added-description')) { ?>
                <div class="user-box-extended box-100 relative">
                    <p>
                        <?php echo renderBreakTagInString(get_the_author_meta( 'added-description' )); ?>
                    </p>
                </div>
            <?php } ?>
