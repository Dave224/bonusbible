					...
					<div class="space-comments-ins case-15 white relative">
						<div class="space-comments-wrap space-page-content relative">
                            <h3 class="comment-first-title">
                                <?php _e("Diskuze, komentáře a vaše zkušenosti", "SLOTH_DOMAIN"); ?>
                            </h3>
                            <p><?php _e("Sdílejte svůj názor, položte otázku nebo nabídněte radu ostatním v moderované diskuzi. Redaktoři se do ní také zapojují, ale reagují podle své momentální vytíženosti. Pokud očekáváte přímou odpověď, doporučujeme spíše využít e-mailovou komunikaci.", "SLOTH_DOMAIN"); ?></p>
